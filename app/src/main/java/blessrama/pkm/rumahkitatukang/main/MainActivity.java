...
//        });
    ...
    private void initiateBottomNavigation() {
        blessrama.pkm.rumahkitatukang.utils.BottomNavigationUtils.removeShiftMode(bottomNavigationView); //disable BottomNavigationView shift mode
        blessrama.pkm.rumahkitatukang.utils.BottomNavigationUtils.resizeBottomNavIcon(bottomNavigationView, this); //resize icon size
